...
export class SidebarProvider implements vscode.WebviewViewProvider {
    ...
    private updateThinking(phase: string, message: string): void {
        if (this.view) {
            this.view.webview.postMessage({
                type: 'updateThinking',
                phase,
    ...
    private showToolUse(tool: string, args: any): void {
        if (this.view) {
            this.view.webview.postMessage({
                type: 'showToolUse',
                tool,
    ...
    private showToolResult(tool: string, result: any): void {
        if (this.view) {
            this.view.webview.postMessage({
                type: 'showToolResult',
                tool,
    ...
    private showPlan(steps: any[], rationale: string): void {
        if (this.view) {
            this.view.webview.postMessage({
                type: 'showPlan',
                steps,
    ...
    private showPatch(patch: any): void {
        if (this.view) {
            this.view.webview.postMessage({
                type: 'showPatch',
                patch
    ...
    private showApprovalRequest(message: any): void {
        if (this.view) {
            this.view.webview.postMessage({
